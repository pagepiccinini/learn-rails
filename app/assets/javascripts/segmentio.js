...
windows.analytics || (window.analytics = []);

// A list of all the methods in analytics.js that we want to stub.
window.analytics.methods = ['identity', 'track', 'trackLink', 'trackFrom', 'trackClick', 'trackSubmit', 'page', 'pageview', 'ab', 'alias', 'ready', 'group', 'on', 'once', 'off'];
...
// first argument, so we know which method to replay the call to.
...
// Define a method that will asychronously load analytics.js from our CDN.
...
// analytics integrations you're turned on for your account. Boosh!
window.analytics.load('7xwvj7eg6q');

// Make our first page call to load the integrations. If you'd like to manually
// name or tag the age, edit or move this call to use your own tags.
/* */
window.analytics.page();

// accomodate Turboinks
